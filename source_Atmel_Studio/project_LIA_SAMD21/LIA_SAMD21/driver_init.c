...
void USB_0_PORT_init(void)
{
	...
	gpio_set_pin_direction(PIN_USB_D0,
	                       // <y> Pin direction
	                       // <id> pad_direction
	...
	gpio_set_pin_pull_mode(PIN_USB_D0,
	...
	gpio_set_pin_function(PIN_USB_D0,
	                      // <y> Pin function
	                      // <id> pad_function
	...
	gpio_set_pin_direction(PIN_USB_D1,
	                       // <y> Pin direction
	                       // <id> pad_direction
	                       // <GPIO_DIRECTION_OFF"> Off
	                       // <GPIO_DIRECTION_IN"> In
	...
	gpio_set_pin_pull_mode(PIN_USB_D1,
	                       // <y> Pull configuration
	                       // <id> pad_pull_config
	                       // <GPIO_PULL_OFF"> Off
	                       // <GPIO_PULL_UP"> Pull-up
	...
	gpio_set_pin_function(PIN_USB_D1,
	                      // <y> Pin function
	                      // <id> pad_function
	                      // <i> Auto : use driver pinmux if signal is imported by driver, else turn off function
...
void system_init(void)
{
    ...
    gpio_set_pin_direction(PIN_D1__SAMPLING,
    // <y> Pin direction
    // <id> pad_direction
    // <GPIO_DIRECTION_OFF"> Off
    // <GPIO_DIRECTION_IN"> In
    ...
    gpio_set_pin_level(PIN_D1__SAMPLING,
    // <y> Initial level
    // <id> pad_initial_level
    // <false"> Low
    // <true"> High
    ...
    gpio_set_pin_pull_mode(PIN_D1__SAMPLING,
    // <y> Pull configuration
    // <id> pad_pull_config
    // <GPIO_PULL_OFF"> Off
    // <GPIO_PULL_UP"> Pull-up
    ...
    gpio_set_pin_function(PIN_D1__SAMPLING,
    // <y> Pin function
    // <id> pad_function
    // <i> Auto : use driver pinmux if signal is imported by driver, else turn off function
